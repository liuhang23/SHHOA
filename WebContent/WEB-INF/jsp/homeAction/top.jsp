        ...
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                <li>
                	...
                	<img border="0" width="11" height="13" src="${pageContext.request.contextPath}/style/images/top/msg.gif" /> 
                	消息<span id="msg"></span>
                </a></li>
                <li class="Line"></li>
                <li>
                	<a target="desktop" href="javascript:void(0)"><img border="0" width="16" height="11" src="${pageContext.request.contextPath}/style/images/top/mail.gif" /> 
                ...
                <!-- 是否有待审批文档的提示1 -->
                <li>
                	<a href="${pageContext.request.contextPath}/formFlowAction_myTaskList.action" target="right">
